...
#pragma warning restore IDE1006
        ...
        private string GetStartCommand(string url, string btcAddress, string worker)
        {
            ...
            var ret = GetDevicesCommandString()
                      ...
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".hk.nicehash.com:" + url.Split(':')[1]
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".in.nicehash.com:" + url.Split(':')[1]
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".usa.nicehash.com:" + url.Split(':')[1]
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".jp.nicehash.com:" + url.Split(':')[1]
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".br.nicehash.com:" + url.Split(':')[1]
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".eu.nicehash.com:" + url.Split(':')[1]
        ...
        protected override string BenchmarkCreateCommandLine(Algorithm algorithm, int time)
        {
            ...
            if (MiningSetup.CurrentAlgorithmType == AlgorithmType.ZHash)
            {
                ...
                ret = GetDevicesCommandString() + ExtraLaunchParametersParser.ParseForMiningSetup(MiningSetup, DeviceType.NVIDIA)
                      ...
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".jp.nicehash.com:" + stratumPort
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".br.nicehash.com:" + stratumPort
                      + " --url " + btcAddress + "." + worker + "@" + algoName + ".eu.nicehash.com:" + stratumPort
                      + " --pass=x" + " --telemetry=" + ApiPort;

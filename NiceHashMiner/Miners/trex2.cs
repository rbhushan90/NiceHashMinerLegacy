...
namespace NiceHashMiner.Miners
{
    public class trex : Miner
    {
       ...
       // private bool _benchmarkException => MiningSetup.MinerPath == MinerPaths.Data.trex;
        ...
        {
            Helpers.ConsolePrint("TREX", "STOP1");
        ...
        protected override bool BenchmarkParseLine(string outdata)
        {
            ...
            protected bool BenchmarkParseLog()
        {
        ...
        protected override void BenchmarkThreadRoutine(object CommandLine)
        {
            ...
            try
            {
                ...
                {
                    Helpers.ConsolePrint("TREX", "STOP2");
                ...
                {
                    Helpers.ConsolePrint("TREX", "STOP3");
                    throw new Exception("Termined by user request");
                }

                if (BenchmarkSignalHanged || !exited)
                {
                    Helpers.ConsolePrint("TREX", "STOP4");
                    throw new Exception("Miner is not responding");
                }

                if (BenchmarkSignalFinnished)
                {
                    Helpers.ConsolePrint("TREX", "STOP5");
                    //break;
                }
            }
            catch (Exception ex)
            {
                Helpers.ConsolePrint("TREX", "STOP6");
            ...
            finally
            {
                ...
                EndBenchmarkProcces();
                Thread.Sleep(1000);
                Helpers.ConsolePrint("TREX", "STOP7");
                BenchmarkThreadRoutineFinish();
                BenchmarkParseLog();
            }
        }
